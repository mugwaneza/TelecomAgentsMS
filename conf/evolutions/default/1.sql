...
alter table inquiry add constraint fk_inquiry_agent_5 foreign key (agent_id) references approved_agents (id) on delete restrict on update restrict;
create index ix_inquiry_agent_5 on inquiry (agent_id);
